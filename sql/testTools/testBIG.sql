...
declare
    pCTX PLOG.LOG_CTX := PLOG.init (pSECTION     => NULL, 
                                    pLEVEL       => PLOG.LDEBUG, 
                                    pLOG4J       => TRUE, 
                                    pLOGTABLE    => TRUE, 
                                    pOUT_TRANS   => TRUE, 
...
select id, length(ltexte) from tlog
/
select * from vlog
/
...
SQL> 
SQL> select id, length(ltexte) from tlog
  2  /
