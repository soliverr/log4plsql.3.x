...
declare
    pCTX       PLOG.LOG_CTX := PLOG.INIT (pDBMS_OUTPUT => TRUE , pLEVEL       => PLOG.LDEBUG) ;
    pCTX1      PLOG.LOG_CTX ; 
    mess       varchar2(4000) ;
begin 
...
SQL>
SQL> declare
  2      pCTX       PLOG.LOG_CTX := PLOG.INIT (pDBMS_OUTPUT => TRUE , pLEVEL       => PLOG.LDEBUG) ;
  3      pCTX1      PLOG.LOG_CTX ;
